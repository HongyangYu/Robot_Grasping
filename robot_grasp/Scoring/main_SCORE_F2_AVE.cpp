...
#define PCD_FILE           "pcd_world_scene3_target.pcd"
#define INPUT_FILE_PATH    "final_configure_scene3.csv"
#define TOTAL_NUMBER_LINE  1630  //pcd1_target: 1670; pcd2_target: 1680; pcd3_target: 1630
#define OUTPUT_FILE_PATH_1 "score_file_scene3_original_ave_target.csv"
#define OUTPUT_FILE_PATH_2 "score_file_scene3_normalize_ave_target.csv"

#define POINT_NUM_THRES 800
	...
	*/
	...
	for(size_t iLineIndex = 0; iLineIndex < TOTAL_NUMBER_LINE; ++iLineIndex)
	{
		...
		*/
		...
		float fAveScore = 0.;  //average score
		...
		if( inum_valid_point >= POINT_NUM_THRES )
		{
			fAveScore = fAccScore/inum_valid_point;
		}
		else
		{
			fAveScore = 0.;
		...
		scorefile << fAveScore << endl;

		if( fAveScore > fMaxAveScore )
		{
			fMaxAveScore = fAveScore;
	...
	printf("The max average score is: %f\n", fMaxAveScore);
	...
	for(size_t iLineIndex = 0; iLineIndex < TOTAL_NUMBER_LINE; ++iLineIndex)
	{
		...
		fAccScore_normalize = fAccScore*1.0/fMaxAveScore;
