...
step_size = 0.03
dist = [0.2, 0.21]
obj_pos = [0.75201818,  0.1678353 ,  0.78826468,  0.07353034, -0.05200369, -0.62835601,  0.77269504]
...
def main():
    ...
    fh = open( 'init_configure_scene2.yaml', 'w' )
    #csv file is used for generate depth images from different view points
    fh_csv = open( 'init_configure_scene2.csv', 'w')
