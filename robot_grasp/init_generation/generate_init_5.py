...
step_size = 0.03
dist = [0.2, 0.21]
obj_pos = [0.6262590, 0.3191910, 0.806013,  0.6303518 , -0.02878308, -0.77486378, -0.03760674]
...
def main():
    ...
    fh = open( 'init_configure_scene5.yaml', 'w' )
    #csv file is used for generate depth images from different view points
    fh_csv = open( 'init_configure_scene5.csv', 'w')
